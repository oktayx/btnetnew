                    ...
                    <form class="frm" runat="server">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input runat="server" type="password" class="form-control" id="password" size="20" maxlength="20" autocomplete="off"></td>
                            </tr>

                            <tr>
                                <td class="lbl">Reenter Password:</td>
                                <td>
                                    <input runat="server" type="password" class="form-control" id="confirm" size="20" maxlength="20" autocomplete="off"></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <input class="btn btn-info" type="submit" value="Change password" runat="server">
                                </td>
                            </tr>
