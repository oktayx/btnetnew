...
<body onload="body_on_load()">
    ...
    <div class="align">
        ...
        <% if (permission_level == Security.PERMISSION_ALL && (security.user.is_admin || security.user.can_edit_tasks))
            { %>
        <a class="btn btn-info" href="edit_task.aspx?id=0&bugid=<% Response.Write(Convert.ToString(bugid)); %>">add new task</a>
        &nbsp;&nbsp;&nbsp;&nbsp;
            <a class="btn btn-info" target="_blank" href="tasks_all.aspx">view all tasks</a>
        &nbsp;&nbsp;&nbsp;&nbsp;
            <a class="btn btn-info" target="_blank" href="tasks_all_excel.aspx">export all tasks to excel</a>
