                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <div runat="server" class="err" id="username_err"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <div runat="server" class="err" id="pw_err"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <div runat="server" class="err" id="confirm_pw_err"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <div runat="server" class="err" id="org_err"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <div runat="server" class="err" id="firstname_err"></div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <div runat="server" class="err" id="lastname_err"></div>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <div runat="server" class="err" id="bugs_per_page_err"></div>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <div runat="server" class="err" id="email_err"></div>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <textarea class="form-control" id="signature" rows="2" runat="server"></textarea>
                                    <div runat="server" class="err" id="signature_err"></div>
                                </td>
                            </tr>
	...
	<span class="smallnote">Delete old subscriptions and create new ones, according to above settings.</span></td>
                    ...
                    <div id="tab3" style="display: none;">
                        <table class="table">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:DataGrid ID="MyDataGrid" runat="server" BorderColor="black" CssClass="table" CellPadding="3" AutoGenerateColumns="false">
...
select scope_identity()";
                    ...
                    Util.update_user_password(id, pw.Value);
