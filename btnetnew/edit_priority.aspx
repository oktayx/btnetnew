...
-->
    ...
    <script type="text/javascript">
        window.addEventListener('DOMContentLoaded', change_sample_color, false);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="align">
        ...
        <table class="table">
            ...
            <tr>
                <td colspan="3">
                    <div class="well smallnote">Background Color and CSS Class can be used to control the look of lists.<br>
            ...
            <tr>
                ...
                <td>
                    <input onkeyup="change_sample_color()" runat="server" type="text" class="form-control" id="color" value="#ffffff" maxlength="7" size="7">
                    <div runat="server" class="err" id="color_err">&nbsp;</div>
                </td>
                <td><span style="padding: 3px;" id="sample">&nbsp;&nbsp;Sample&nbsp;&nbsp;</span></td>
            </tr>

            <tr>
                <td class="lbl">CSS Class:</td>
                <td colspan="2">
                    <input runat="server" type="text" class="form-control" id="style" value="" maxlength="10" size="10">
                    &nbsp;&nbsp;<a target="_blank" href="edit_styles.aspx">more CSS info...</a>
                    <div runat="server" class="err" id="style_err">&nbsp;</div>
                </td>
            </tr>
