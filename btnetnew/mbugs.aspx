...
void Page_Load(Object sender, EventArgs e)
{
    ...
    titl.InnerText = Util.get_setting("AppTitle", "BugTracker.NET") + " - List ";
    my_header.InnerText = titl.InnerText;
    create.InnerText = "Create " + Util.capitalize_first_letter(Util.get_setting("SingularBugLabel", "bug"));
    only_mine_label.InnerText = "Show only " + Util.get_setting("PluralBugLabel", "bugs") + " reported by or assigned to me";
