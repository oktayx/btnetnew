...
<a href=categories.aspx>back to categories</a>
	...
	<td><input runat="server" type=text class="form-control" id="name" maxlength=30 size=30></td>
	...
	<td><input runat="server" type=text class="form-control" id="sort_seq" maxlength=2 size=2></td>
