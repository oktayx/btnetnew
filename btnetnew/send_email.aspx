...
update bugs set
	...
	where bg_id = $id";
        ...
        Bug.send_notifications(Bug.UPDATE, Convert.ToInt32(bg_id.Value), security);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="table">
        ...
        <tr>
            <td class="lbl">To:</td>
            <td valign="top">
                <textarea runat="server" class="form-control" id="to" rows="2"></textarea>
                <input type="button" value="addresses" onclick="show_addrs(this, 'to')" class="" style="float: right;">
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="from" CssClass="form-control" runat="server">
                </asp:DropDownList>
            </td>
        ...
        <tr>
            <td class="lbl">CC:</td>
            <td valign="top">
                <textarea runat="server" class="form-control" id="cc" cols="80" rows="2"></textarea>
                <input type="button" value="addresses" onclick="show_addrs(this, 'cc')" class="" style="float: right;">
            </td>
        ...
        <tr>
            ...
            <td>
                <input runat="server" type="text" class="form-control" id="subject" maxlength="200" size="100"></td>
        ...
        <tr>
            ...
            <td>
                <input runat="server" type="file" class="form-control" id="attached_file" maxlength="255" size="100"></td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="prior" CssClass="form-control" runat="server">
        ...
        <tr>
            <td colspan="2">
                <input runat="server" type="checkbox" class="txt" id="include_internal_posts"><span id="include_internal_posts_label" runat="server">Include comments visible to internal users only</span></td>
        </tr>

        <tr>
            <td colspan="3">
                <textarea rows="15" runat="server" class="form-control" id="body"></textarea>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2" align="center">
                <input runat="server" class="btn btn-info" type="submit" id="sub" value="Send" style="font-size: larger; padding-left: 20px; padding-right: 20px;">
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
            ...
            <%
                ...
                if (Session["email_addresses"] == null)
                {
					...
					order by us_email";
                        ...
                        DataSet ds_users_for_this_project = DbUtil.get_dataset(sql);
                    ...
                    DataTable dt_related_users = Util.get_related_users(security, true); // force full names
                                                                                         // let's sort by email
