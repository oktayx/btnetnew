...
namespace btnet
{
	...
	public class BugList {
            ...
            )
        {
            ...
            Response.Write("<table class='table'><tr><td align=left valign=top>");
            ...
            Response.Write("\n<table class='table table-bordered table-condensed' border=1 ><tr>\n");
            ...
            foreach (DataColumn dc in dv.Table.Columns)
            {
                ...
                if (db_column_count == 0)
                {
                    ...
                    if (show_checkbox)
                    {
                        ...
                        Response.Write("<td><font size=0>sel</font>");
                    }
                }
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else if (i == search_source_column)
                                    {
                                        ...
                                        {
                                            string[] parts = Util.split_string_using_commas(val);
