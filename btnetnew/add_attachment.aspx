                        ...
                        <form target="hiddenframe" class="frm" runat="server" enctype="multipart/form-data" onsubmit="return waiting()">
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="file_input">
                                            <input runat="server" type="file" class="form-control" id="attached_file" maxlength="255" size="60">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <input runat="server" class="btn btn-info" type="submit" id="sub" value="Upload">
                                    </td>
                                </tr>
                            </table>
                        </form>
