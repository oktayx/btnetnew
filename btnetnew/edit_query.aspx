...
select us_id, us_username from users order by us_username";
                ...
                DataSet ds_orgs_and_users = DbUtil.get_dataset(sql);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="table">
		...
		<asp:RadioButton Text="Just User" runat="server" GroupName="visibility" ID="vis_user" />
                &nbsp;&nbsp;&nbsp;
		<asp:DropDownList ID="user" CssClass="form-control" runat="server">
        </asp:DropDownList>
                &nbsp;&nbsp;
		<span runat="server" class="err" id="user_err">&nbsp;</span>
                ...
                <asp:DropDownList ID="org" CssClass="form-control" runat="server">
                </asp:DropDownList>
                &nbsp;&nbsp;
		<span runat="server" class="err" id="org_err">&nbsp;</span>
            ...
            <tr>
                <td colspan="3">
                    ...
                    <textarea style="height: 300px;" runat="server" class="form-control" name="sql_text" id="sql_text"></textarea></td>
    ...
    <div id="explanation" class="well" runat="server">
