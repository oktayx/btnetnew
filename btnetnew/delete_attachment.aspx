...
<script language="C#" runat="server">
    ...
    void Page_Load(Object sender, EventArgs e)
    {
        ...
        int permission_level = Bug.get_bug_permission_level(Convert.ToInt32(bug_id_string), security);
        ...
        else
        {
            ...
            confirm_href.Value = "confirm delete of attachment: " + s;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="align">
        ...
        <p>
            or<p>
                    <input type="submit" id="confirm_href" class="btn btn-danger" runat="server" value="Delete"/>
