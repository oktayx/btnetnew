...
function sort_by_col_impl() {
    ...
    document.getElementById("sortedby").firstChild.nodeValue = "Sorted by " + getInnerTextHelper(table.rows[0].cells[col]) + (asc ? " asc" : " desc");
    ...
    string_array[k++] = "<table id=" + table.id + " class='table table-bordered'>"
