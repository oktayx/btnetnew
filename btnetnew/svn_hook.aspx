...
string get_bugids_from_msg(string msg)
{
    ...
    string regex_pattern1 = Util.get_setting("SvnBugidRegexPattern1", "([0-9,]+$)");  // at end
	...
	{
        string regex_pattern2 = Util.get_setting("SvnBugidRegexPattern2", "(^[0-9,]+ )");  // comma delimited at start
