...
void Page_Load(Object sender, EventArgs e)
{
    ...
    else
    {
        ...
        titl.InnerText = Util.get_setting("AppTitle", "BugTracker.NET") + " - Update";
        my_header.InnerText = titl.InnerText;
        ...
        DataRow dr = Bug.get_bug_datarow(id, security);
...
string update_bug() {
    ...
    bool bugpost_fields_have_changed = (Bug.insert_comment(
        id,
        security.user.usid,
        comment_text,
        comment_text,
