...
<script language="C#" runat="server">
    ...
    void Page_Load(Object sender, EventArgs e)
    {
        ...
        {
            DataSet ds = DbUtil.get_dataset("select name from sysobjects where type = 'u' order by 1");
    ...
    <div class="container">
        <table class="table">
            ...
            <tr>
                ...
                <td style="border: red solid 2px; background: yellow; color: #ff0000; font-weight: bold; font-size: 8pt; padding: 4px;">
                This page is not safe on a public web server.
After you install BugTracker.NET on a public web server, please delete it.

            <tr>
                <td>
                    <select id="dbtables_select" class="form-control" runat="server" onchange="on_dbtables_changed()" />
			...
			<br>
                        ...
                        <p>
                            <input runat="server" class="btn" type='submit' value="Execute SQL">
                    </form>
