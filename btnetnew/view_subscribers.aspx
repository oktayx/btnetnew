    ...
    void Page_Load(Object sender, EventArgs e)
    {
        ...
        if (action != "")
        {
			...
			insert into bug_subscriptions (bs_bug, bs_user) values($bg, $us)"; ;
                ...
                Bug.send_notifications(Bug.UPDATE, bugid, security, new_subscriber_userid);
            }
        }
                        ...
                        <table>
                            <tr>
                                <td><span class="lbl">add subscriber:</span>
                                    ...
                                    <asp:DropDownList ID="userid" CssClass="form-control" runat="server">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <span runat="server" class='err' id="add_err"></span>
                                </td>
                            </tr>
                        </table>
