...
<script language="C#" runat="server">
    ...
    void print_as_html()
    {
        ...
        Response.Write("<html><head><link rel='StyleSheet' href='Content/bootstrap.min.css' type='text/css'><link rel='StyleSheet' href='btnet.css' type='text/css'></head><body>");
...
<%--<html>
<head>
    <title id="titl" runat="server">btnet print</title>
