...
void create_table(string title, DataSet ds)
{
    ...
    Response.Write("<link rel=StyleSheet href='Content/bootstrap.min.css' type='text/css'>");
	Response.Write("<s" + "cript");
	Response.Write(" type='text/javascript' src='sortable.js'>");
	Response.Write("</s" + "cript>");
    ...
    //}
    Response.Write (">\n<div class=align><table class='table'><tr><td>");
