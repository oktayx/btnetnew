...
{
	string[] vals_array = Util.split_dropdown_vals(vals_string);
...
<script>
    ...
    function getElementsByDivId(id) {
        var matches = [];
        var searchEles = document.getElementById(id).children;
    ...
    function createFormByDiv(id) {
        var f = document.createElement("form");
        //f.setAttribute('method', "post");
        //f.setAttribute('action', "submit.php");

        var elements = getElementsByDivId(id);
        for (var i = 0; i < elements.length; i++) {
            f.appendChild(elements[i]);
        }
        return f;
    }
...
<% security.write_menu2(Response, "search"); %>
...
<table border=0 cellpadding=6 cellspacing=0>
	...
	<tr>
		...
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="reported_by" ClientIDMode="Static" CssClass="form-control" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="category_label" ClientIDMode="Static" runat="server">category:</span><br>
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="category" CssClass="form-control" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="priority_label" ClientIDMode="Static" runat="server">priority:</span><br>
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="priority" CssClass="form-control" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="assigned_to_label" ClientIDMode="Static" runat="server">assigned to:</span><br>
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="assigned_to" CssClass="form-control" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="status_label" ClientIDMode="Static" runat="server">status:</span><br>
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="status" CssClass="form-control" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>
	</tr>
...
<table border=0 cellpadding=3 cellspacing=0>
	<tr>
		...
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="org" CssClass="form-control" ClientIDMode="Static" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="project_label" ClientIDMode="Static" runat="server">project:</span><br>
			<asp:ListBox Rows=6 SelectionMode="Multiple" id="project" CssClass="form-control" runat="server" onchange="set_project_changed()"
			AutoPostBack="true">
			</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="project_custom_dropdown1_label" ClientIDMode="Static" runat="server" style="display:none">?</span><br>
			<asp:ListBox Rows=6 SelectionMode="Multiple" id="project_custom_dropdown1" CssClass="form-control" runat="server" style="display:none" onchange="on_change()">
			</asp:ListBox>
		</td>
		<td nowrap><span class=lbl id="project_custom_dropdown2_label" ClientIDMode="Static" runat="server" style="display:none">?</span><br>
			<asp:ListBox Rows=6 SelectionMode="Multiple" id="project_custom_dropdown2" CssClass="form-control" runat="server" style="display:none" onchange="on_change()">
			</asp:ListBox>
		</td>
		<td nowrap><span class=lbl id="project_custom_dropdown3_label" ClientIDMode="Static"  runat="server" style="display:none">?</span><br>
			<asp:ListBox Rows=6 SelectionMode="Multiple" id="project_custom_dropdown3" CssClass="form-control" runat="server" style="display:none" onchange="on_change()">
			</asp:ListBox>
		</td>
	</tr>
...
<table border=0 cellpadding=3 cellspacing=0>
	<tr>
		...
		<td colspan=2><input type=text class="txt form-control input-sm" id="like" ClientIDMode="Static" CssClass="form-control" runat="server" onkeydown="search_criteria_onkeydown(this,event)" onkeyup="search_criteria_onkeyup(this,event)"  size=50 autocomplete="off">


		<% if (show_udf)
		{
		%>
		<td nowrap rowspan=2><span class=lbl id="udf_label" ClientIDMode="Static" runat="server"><% Response.Write (Util.get_setting("UserDefinedBugAttributeName","YOUR ATTRIBUTE")); %></span><br>
			<asp:ListBox Rows=4 SelectionMode="Multiple" id="udf" ClientIDMode="Static" CssClass="form-control" runat="server" onchange="on_change()">
			</asp:ListBox>
	...
	<tr>
		...
		<td colspan=2><input type=text class="txt form-control  input-sm" id="like2" ClientIDMode="Static" CssClass="form-control" runat="server" onkeyup="on_change()" size=50  autocomplete="off">
		</td>
	</tr>
	...
	<tr>
		...
		<td colspan=2><input type=text class="txt date form-control  input-sm" id="comments_since" ClientIDMode="Static" runat="server" onkeyup="on_change()" size=10>
	...
	<tr>
		...
		<td colspan=2><input runat="server" type=text class="txt date form-control  input-sm"  id="from_date" ClientIDMode="Static" maxlength=10 size=10 onchange="on_change()">
			<a style="font-size: 8pt;"
			...
			<input runat="server" type=text class="txt date form-control  input-sm"  id="to_date" ClientIDMode="Static" maxlength=10 size=10 onchange="on_change()">
			<a style="font-size: 8pt;"
	...
	<tr>
		...
		<td colspan=2><input runat="server" type=text class="txt date form-control  input-sm"  id="lu_from_date" ClientIDMode="Static" maxlength=10 size=10 onchange="on_change()">
			<a style="font-size: 8pt;"
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			<span class=lbl>to:&nbsp;</span>
			<input runat="server" type=text class="txt date form-control  input-sm"  id="lu_to_date" ClientIDMode="Static" maxlength=10 size=10 onchange="on_change()">
			<a style="font-size: 8pt;"
    ...
    else
    {
        if (dv.Table.Rows.Count > 0)
        {
            ...
            if (!security.user.is_guest && (security.user.is_admin || security.user.can_mass_edit_bugs))
            {
                ...
                Response.Write("<div id=massform>");
                display_bugs(true);
                ...
                //Response.Write("</form>");
                Response.Write("<p><script>load_massedit_selects()</script>");
                Response.Write("</div>");
            }
            else
            {
