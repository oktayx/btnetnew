...
<script language="C#" runat="server">
    ...
    void on_update()
    {
        ...
        && prev_into_bug.Value == into_bug.Value)
        {
            ...
            prev_from_bug.Value = Util.sanitize_integer(prev_from_bug.Value);
            prev_into_bug.Value = Util.sanitize_integer(prev_into_bug.Value);
...
";
            ...
            Bug.send_notifications(Bug.UPDATE, Convert.ToInt32(prev_into_bug.Value), security);
...
into "INTO" <% Response.Write(Util.get_setting("SingularBugLabel", "bug")); %>.
    ...
    <span class="err">Note:&nbsp;&nbsp;"FROM" <% Response.Write(Util.get_setting("SingularBugLabel", "bug")); %> will be deleted!</span>
    <table class="table">
        <tr>
            <td class="lbl">FROM <% Response.Write(Util.get_setting("SingularBugLabel", "bug")); %>:
            <td>
                <input type="text" class="form-control" id="from_bug" runat="server" size="8">
        ...
        <tr>
            <td class="lbl">INTO <% Response.Write(Util.get_setting("SingularBugLabel", "bug")); %>
                    :</td>
            <td>
                <input type="text" class="form-control" id="into_bug" runat="server" size="8">
        ...
        <tr>
            <td colspan="2" align="center">
                <br>
                <input class="btn btn-info" type="submit" runat="server" id="submit" value="Merge">
            </td>
        </tr>
    </table>
