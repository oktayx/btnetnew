                ...
                <form class="frm" runat="server">
                    <table class="table">
                        ...
                        <tr runat="server" id="assigned_to_tr">
                            ...
                            <td>
                                <asp:DropDownList CssClass="form-control" ID="assigned_to" runat="server"></asp:DropDownList></td>
                            <td>&nbsp</td>
                        </tr>
                        ...
                        <tr runat="server" id="duration_units_tr">
                            ...
                            <td>
                                <asp:DropDownList CssClass="form-control" ID="duration_units" runat="server">
                        ...
                        <tr runat="server" id="status_tr">
                            ...
                            <td>
                                <asp:DropDownList CssClass="form-control" ID="status" runat="server"></asp:DropDownList></td>
                            <td>&nbsp</td>
                        </tr>
