...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="tab1" style="display: block;">
        <table class="table">
            <tr>
                ...
                <td colspan="2">
                    <input runat="server" type="text" class="form-control" id="name" maxlength="30" size="30">
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:DropDownList ID="default_user" CssClass="form-control" runat="server">
                    </asp:DropDownList></td>
            </tr>
	...
	<br>
            ...
            <tr>
                ...
                <td colspan="2">
                    <input runat="server" type="text" class="form-control" id="pop3_username" maxlength="50" size="30"></td>
            </tr>

            <tr>
                <td class="lbl">Pop3 Password:</td>
                <td colspan="2">
                    <input runat="server" type="password" class="form-control" id="pop3_password" maxlength="20" size="20"></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <input runat="server" type="text" class="form-control" id="pop3_email_from" maxlength="50" size="30"></td>
            </tr>

            <tr>
                <td class="lbl">Description:</td>
                <td colspan="2">
                    <textarea runat="server" class="form-control" id="desc" rows="5"></textarea>
                    <div runat="server" class="err" id="desc_err">&nbsp;</div>
                </td>
            </tr>
    ...
    <div id="tab2" style="display: none;">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <input runat="server" type="text" class="form-control" id="custom_dropdown_label1" maxlength="30" size="30"></td>
                <td>&nbsp</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <textarea rows="2" runat="server" type="text" class="form-control" id="custom_dropdown_values1"></textarea></td>
            ...
            <tr>
                ...
                <td>
                    <input runat="server" type="text" class="form-control" id="custom_dropdown_label2" maxlength="30" size="30"></td>
                <td>&nbsp</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <textarea rows="2" runat="server" type="text" class="form-control" id="custom_dropdown_values2"></textarea></td>
            ...
            <tr>
                ...
                <td>
                    <input runat="server" type="text" class="form-control" id="custom_dropdown_label3" maxlength="30" size="30"></td>
                <td>&nbsp</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <textarea rows="2" runat="server" type="text" class="form-control" id="custom_dropdown_values3"></textarea></td>
