                ...
                <td>
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td>
                                <input runat="server" type="text" class="form-control" id="og_name" maxlength="30" size="30"></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input runat="server" type="text" class="form-control" id="og_domain" maxlength="80" size="30">
                            </td>
